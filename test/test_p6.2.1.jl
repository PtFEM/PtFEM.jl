...
@test m ≈ [10,519.0,-0.0711629,250] atol=1.0e-6

disp = convert(Array, m[:disp])
iters = convert(Array, m[:iters])

@test disp ≈ [-0.006592,-0.011549,-0.016301,-0.023168,
  -0.033209,-0.042347,-0.050963,-0.056795,-0.061011,-0.071079] atol=1.0e-6
