...
function FEbeamold(nels::Int64, nn::Int64, data::Dict;
  ...
  FEbeamold(nels, nn, ndim, nod, nprops, np_types, nodof, ndof,
...
function model_show(io::IO, m::FEbeamold, compact::Bool=false)
  if compact==true
    println("FEbeamold(")
  else
    println("  nels =                    \"$(m.nels)\"")
...
show(io::IO, m::FEbeamold) = model_show(io, m, false)
showcompact(io::IO, m::FEbeamold) = model_show(io, m, true)
