...
""" ->
function mesh_size(fetype::Triangle, nod::Int64, nxe::Int64, nye::Int64)
  nn=0; nels=nxe*nye*2
  if nod==3
    nn=(nxe+1)*(nye+1)
  elseif nod==6
...
function mesh_size(fetype::Quadrilateral, nod, nxe, nye)
  nn=0; nels=nxe*nye
  if nod==4
    nn=(nxe+1)*(nye+1)
  elseif nod==5
...
""" ->
function mesh_size(fetype::Hexahedron, nod, nxe, nye, nze)
