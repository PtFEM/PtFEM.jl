@doc """
Function spabac(kv, loads, kdiag) performs Cholesky forward and back-substitution on a symmetric skyline global matrix. The loads vector is updated.

Required arguments to spabac!() are:
