...
function FEaxisymmetric(nels::Int64, nn::Int64, data::Dict;
  ...
  FEaxisymmetric(nels, nn, ndim, nod, nprops, np_types, nodof, ndof,
...
function model_show(io::IO, m::FEaxisymmetric, compact::Bool=false)
  if compact==true
    println("FEmodel(")
  else
    println("  nels =                    \"$(m.nels)\"")
...
show(io::IO, m::FEaxisymmetric) = model_show(io, m, false)
showcompact(io::IO, m::FEaxisymmetric) = model_show(io, m, true)
